...
description: Learn how to receive activity updates from bots. See how to use the Direct Line 3.0 protocol to connect by using either WebSocket streams or HTTP GET requests.
author: RobStand
ms.author: kamrani
manager: kamrani
ms.topic: article
