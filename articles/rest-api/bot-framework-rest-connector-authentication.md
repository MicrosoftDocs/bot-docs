...
This example shows how to specify the access token in the `Authorization` header of the request:

```http
POST https://api.botframework.com/v3/conversations/12345/activities 
