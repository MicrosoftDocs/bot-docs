...
description: Become familiar with authentication in Direct Line API 1.1. See how to use secrets and tokens to access conversations. Learn how to refresh tokens.
author: RobStand
ms.author: kamrani
manager: kamrani
ms.topic: article
