...
Direct Line clients can be in different languages and locations (e.g. a desktop app instead of a web page). For more information, see [About Direct Line](https://docs.microsoft.com/azure/bot-service/bot-service-channel-directline?view=azure-bot-service-4.0).
