...
1. In the the drop-down list select **Speech**. It will open a page describing this resource type.
...
1. In the right pane, select the box by the **Enable Streaming Endpoint**.
...
1. In the left pane, in the **App Service Settings** category, select **Configuration**.
...
The Bot Framework Protocol Streaming Extensions are now enabled for your bot. You are now ready to update your bot code and [integrate Streaming Extensions support](directline-speech-bot.md) to an existing bot project.
