...
### [Choose a hosting plan](~/azure/azure-bot-service-hosting.md)
### Create a bot
#### [Templates](~/azure/azure-bot-service-templates.md)
#### [Create a basic bot](~/azure/azure-bot-service-serverless-template-basic.md)
#### [Create a form bot](~/azure/azure-bot-service-serverless-template-form.md)
...
### [Use the build tab](~/azure/azure-bot-service-build-options.md)
### [Publish a bot](~/azure/azure-bot-service-continuous-deployment.md)
### [Migrate a consumption plan bot into a web app bot](~/azure/azure-bot-service-migration.md)
