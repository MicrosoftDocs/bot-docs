...
When your bot receives an <a href="https://docs.microsoft.com/en-us/dotnet/api/microsoft.bot.connector.activity" target="_blank">Activity</a> object from the Connector, 
...
- <a href="https://docs.microsoft.com/en-us/dotnet/api/microsoft.bot.connector.connectorclient" target="_blank">ConnectorClient class</a>

[ConnectorClient]: https://docs.microsoft.com/en-us/dotnet/api/microsoft.bot.connector.connectorclient