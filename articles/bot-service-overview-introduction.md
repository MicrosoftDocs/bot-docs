...
## Plan 
Before writing code, review the bot [design guidelines](bot-service-design-principles.md) for best practices and identify the needs for your bot. You can create a simple bot or include more sophisticated capabilities, such as speech, language understanding, QnA, or the ability to extract knowledge from different sources and provide intelligent answers. To get started, you can use the [CLI tools](~/bot-builder-create-templates.md), [Azure portal](bot-service-quickstart.md), or the templates below.
...
| --- | --- |
| [LUIS](https://docs.microsoft.com/en-us/azure/cognitive-services/luis/home) | Add language understanding |
| [QnA Maker](https://docs.microsoft.com/en-us/azure/cognitive-services/qnamaker/home)  | Add a knowledge base to answer questions users ask |
| [Dispatch tool](~/v4sdk/bot-builder-tutorial-dispatch.md) | If using more than one model, intelligently determine when to use which one |
| [Rich media](v4sdk/bot-builder-howto-add-media-attachments.md) | Enhance the user experience with media cards or speech |
| [Speech](https://azure.microsoft.com/services/cognitive-services/speech/) | Convert audio to text, understand intent, and convert text back to speech |
| [Spelling](https://azure.microsoft.com/services/cognitive-services/spell-check/) | Correct spelling errors, recognize the difference among names, brand names, and slang |
