---
title: Bot Framework Design - Handoff between Bot and Human | Microsoft Docs
description: Guidance for designing a conversational application (bot) that requires handoff from bot to human.
keywords: bot framework, design, bot, scenario, use case, pattern, bot to human
author: matvelloso
manager: larar
ms.topic: Bot Scenario - Handoff from Bot to Human
