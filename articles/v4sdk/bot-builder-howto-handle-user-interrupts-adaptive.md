...
- `botName`: Use the same value that you used for **Name** in step 3 of the [Create LUIS resources in Azure portal](#create-luis-resources-in-the-azure-portal-and-configuring-your-bot) section above.
