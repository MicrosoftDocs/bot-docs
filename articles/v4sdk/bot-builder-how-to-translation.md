...
* `Microsoft.Bot.Builder.Ai` (required for translation)
...
You can configure your bot to call the translator for every message received from a user, by simply adding it to your bot's middleware stack. The middleware uses the translation result to modify the user's message using the context object.
