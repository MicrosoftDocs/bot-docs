...
Now that we have the resources required fot the bot created in Azure, let's proceed to upload the code. We will need first to prepare the code to be uloaded, and the zip the code and push it to the cloud:
