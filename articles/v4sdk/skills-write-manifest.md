...
The following table describes the full schema for v2.1 of the Bot Framework skill manifest.
...
Here is a sample activity description.
...
Here is a sample subschema for flight booking information.
...
Here is a sample dispatch model that contains two languages models across three locales. It also describes two top-level intents that the skill can recognize.
...
Here is a full sample v2.1 manifest for a skill that exposes multiple activities.

[!code-json[sample 2.1 manifest](~/../botframework-sdk/schemas/skills/v2.1/samples/complex-skillmanifest.json)]

### [v2.0](#tab/v2-0)

Here is a full sample v2.0 manifest for a skill that exposes multiple activities.
