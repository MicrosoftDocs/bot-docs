...
- Familiarity with article: Create a bot locally for [.NET](../dotnet/bot-builder-dotnet-sdk-quickstart.md), [JavaScript](../javascript/bot-builder-javascript-quickstart.md), or [Python](../python/bot-builder-python-quickstart).
