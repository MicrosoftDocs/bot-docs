...
> |Article|Description|
> |-------------|----------|
> |[Bot Framework security guidelines <img width=200px/>](bot-builder-security-guidelines.md)| Describes security in general and as it applies to the Bot Framework.|
