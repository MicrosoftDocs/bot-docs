...
This article assumes that you have a bot ready to be deployed. For information on how to create a simple echo bot, [Tutorial: Create a basic bot](bot-builder-tutorial-create-basic-bot.md)
