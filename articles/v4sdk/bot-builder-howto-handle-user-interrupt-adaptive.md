...
## Creating LUIS resources in Azure portal and configuring your bot
...
The first thing that happens when `rootDialog` is created is defining its recognizer. In this sample you will be using the LUIS as your recognizer. Instructions for getting your bot to work using the LUIS recognizer are detailed in the section [Setting up LUIS](#setting-up-luis).
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.cs?range=31-34&highlight=4)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.cs?range=99-112)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.cs?range=29-35&highlight=1,7)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.cs?range=42-52)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.cs?range=53-60)]
...
[!code-lg[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.lg?range=4-8)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.cs?range=61-86)]
...
[!code-lg[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.lg?range=16-23)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/GetUserProfileDialog/GetUserProfileDialog.cs?range=30-36&highlight=1,7)]
...
[!code-json[env](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/RootDialog/RootDialog.lu?range=1-5)]
...
[!code-csharp[PropertyAssignment](~/../csharp_dotnetcore/adaptive-dialog/05.interruptions-bot/Dialogs/GetUserProfileDialog/GetUserProfileDialog.cs?range=53-55,64-71)]
