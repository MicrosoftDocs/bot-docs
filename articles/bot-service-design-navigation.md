...
>
> _Don't_: Design your bot to provide unsolicited information that is unlikely to be useful to the user.
...
>
> _Don't_: Design your bot to interject information from past conversations when it is not relevant to the current conversation.
