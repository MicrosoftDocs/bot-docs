...
Learn [how to add language understanding](cognitive-services-add-language.md) to your bot.
...
Learn [how to add image and video understanding](cognitive-services-add-vision.md) to your bot.    
...
Learn [how to add speech recognition and conversion](cognitive-services-add-speech.md) to your bot.
...
Learn [how to add knowledge extraction](cognitive-services-add-knowledge.md) to your bot.
...
Learn [how to add search](cognitive-services-add-search.md) to your bot. 
...
Learn [how to add the location control](cognitive-services-add-location-control.md) to your bot.
