...
> [!IMPORTANT]
> The Bot Framework SDK repository has been archived on GitHub. This project is no longer updated or maintained. However, customers using this tool won't be disrupted. The tool is no longer supported through service tickets in the Azure portal and won't receive product updates.
>
