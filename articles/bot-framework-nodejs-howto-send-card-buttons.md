...
* [HeroCard][HeroCard]
* [Message][Message]
* [How to send attachments](bot-framework-nodejs-howto-send-receive-attachments.md)

[HeroCard]: https://docs.botframework.com/en-us/node/builder/chat-reference/classes/_botbuilder_d_.herocard
[MessageOrder]: bot-framework-nodejs-howto-manage-conversation-flow.md#message-ordering
