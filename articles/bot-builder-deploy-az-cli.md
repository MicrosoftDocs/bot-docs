...
>
> Zip the **contents** of your project folder and **not** the folder by itself. Your zip file should have the structure:
> - `code.zip/[each project file]` and **not** `code.zip/myBot/[each project file]`
>
