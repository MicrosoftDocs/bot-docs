...
5. Next, you need to add the _telemetry middleware_ to the [adapter middleware pipeline](https://docs.microsoft.com/en-us/azure/bot-service/bot-builder-concept-middleware?view=azure-bot-service-4.0#the-bot-middleware-pipeline), to do this add the following code, starting just after the error handling code:  
