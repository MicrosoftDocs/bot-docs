...
|**Scopes** |Space separated list of the API permissions you granted AAD identity provider app| Values such as `openid` `profile` `Mail.Read` `Mail.Send` `User.Read` `User.ReadBasic.All` |
|||
