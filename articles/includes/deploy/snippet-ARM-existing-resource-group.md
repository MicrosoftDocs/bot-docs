...
- `appId` - The `appId` value generated by the [3.1 create the application registration](https://docs.microsoft.com/azure/bot-service/bot-builder-deploy-az-cli?view=azure-bot-service-4.0&tabs=csharp#3-create-the-application-registration) step.
- `appSecret` - The password you provided in the the [3.1 create the application registration](https://docs.microsoft.com/azure/bot-service/bot-builder-deploy-az-cli?view=azure-bot-service-4.0&tabs=csharp#3-create-the-application-registration) step.
