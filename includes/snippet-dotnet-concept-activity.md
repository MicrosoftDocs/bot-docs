The [Connector service](~/bot-framework-dotnet-concepts.md#connector) uses an **Activity** object to pass information back and forth between bot and channel (user). 
