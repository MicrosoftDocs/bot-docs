...
| Sample names | **Bold** on first use. Match the sample name (use the name in the README). | A copy of the **Proactive messages** sample in [**C#**](#), [**JavaScript**](#), or [**Python**](#). | 2018: See [Localization](#localization) note. |
